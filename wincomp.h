...
{
    CompositionWindow(std::function<void(const winrt::Windows::UI::Composition::Compositor&, const winrt::Windows::UI::Composition::Visual&)> func) noexcept : CompositionWindow()
    {
...
private:
    UINT m_currentWidth = 1024;
    UINT m_currentHeight = 1024;

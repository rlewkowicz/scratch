...
Layer::Layer(int width, int height, const ComPtr<IDXGIFactory2>& dxgiFactory,
...
// Compositor class implementation
Compositor::Compositor(ID3D11Device* aDevice, HWND hWnd) : pD3DDevice(aDevice) {
    HRESULT hr;
...
Layer* Compositor::create_layer(int width, int height) {
    Layer* layer =
